export default class PostService {
    ...
    find(slug) {
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                let findPost = this.posts.sort((a, b) => b.createdAt - a.createdAt).find(post => post.slug.toLowerCase() === slug.toLowerCase());
                if (findPost) {
                    resolve({post: findPost});
                } else {
